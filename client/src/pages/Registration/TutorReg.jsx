...
export default function TutorReg() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if(!formData.name||!formData.email||!formData.pass||!formData.inst||!formData.department){
            ...
            <main className="flex-1 flex items-center justify-center px-4 py-32">
                ...
                >
                    ...
                    <input
                        ...
                        required
                        maxLength="50"
                        className="w-full p-2 mb-4 border border-gray-300 rounded focus:outline-none focus:border-purple-500 text-gray-900"
                    />
